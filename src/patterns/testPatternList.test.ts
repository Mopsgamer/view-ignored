...
describe(".gitignore patternListCompile", () => {
	...
	test("stringCompile .git .Git/message nocase true", () => {
		expect(patternCacheTest(patternListCompile({ list: [".git"], nocase: true }), ".Git/message")).toBeTrue()
	})
	...
	test("stringCompile node_modules node_modules/x/message.ts", () => {
		expect(patternCacheTest(patternListCompile({ list: ["node_modules"] }), "node_modules/x/message.ts")).toBeTrue()
	})
	...
	test("stringCompile /message .git/message/file", () => {
		expect(patternCacheTest(patternListCompile({ list: ["/message"] }), ".git/message/file")).toBeFalse()
	})
	...
	test("stringCompile .git/ .git/message/file", () => {
		expect(patternCacheTest(patternListCompile({ list: [".git/"] }), ".git/message/file")).toBeTrue()
	})
	...
	test("stringCompile .git/ .github/message/file", () => {
		expect(patternCacheTest(patternListCompile({ list: [".git/"] }), ".github/message/file")).toBeFalse()
	})
