// Original test case verifying npm-packlist behavior for bundled-files-glob.
// https://github.com/npm/npm-packlist/blob/d1eed617b1ff1eedf5909efec7867aee385d0350/test/bundled-files-glob.js
