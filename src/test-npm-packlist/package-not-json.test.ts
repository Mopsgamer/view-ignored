// Original test case verifying npm-packlist behavior for package-not-json.
// https://github.com/npm/npm-packlist/blob/d1eed617b1ff1eedf5909efec7867aee385d0350/test/package-not-json.js
...
describe.skipIf(process.env.TEST_PACKLIST == "0")("npm-packlist package-not-json", () => {
...
`
		await testScan(
			...
			{ target: makeNPM("list"), dirs: false },
		)
	})
})
