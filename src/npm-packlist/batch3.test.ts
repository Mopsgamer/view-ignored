...
describe("npm-packlist batch 3 (bundled dependencies)", () => {
	const elfJS = "console.log(\"i'm a elf\")"
	...
	test("includes bundled dependency using bundleDependencies", async () => {
		await runPacklistTest(
			...
			["elf.js", "node_modules/history/index.js", "node_modules/history/package.json", "package.json"],
		)
	})
